...
[Deployed Link](https://teach-pod-great.herokuapp.com/)
...
## Usage:
Run npm start in both the root and client folder, and visit the local site at http://localhost:3000/, or visit the launched site at [Deployed](#Deployed)
